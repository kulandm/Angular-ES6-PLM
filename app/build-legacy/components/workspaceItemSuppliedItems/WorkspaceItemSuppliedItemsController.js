 ...
 *
 */
.controller('WorkspaceItemSuppliedItemsController', ['$scope', '$window', '$stateParams', '$location', '$filter', 'LocalizationData', 'ModelsManager', 'ChangeLogObj', 'UserObj', 'FlyoutService', 'ClientSortService', '_', function ($scope, $window, $stateParams, $location, $filter, LocalizationData, ModelsManager, ChangeLogObj, UserObj, FlyoutService, ClientSortService, _) {
...
//# sourceMappingURL=WorkspaceItemSuppliedItemsController.js.map
