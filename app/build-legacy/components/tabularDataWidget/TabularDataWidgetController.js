...
angular.module('plm360.tabularDataWidget').controller('TabularDataWidgetController', ['$scope', '_', '$log', function ($scope, _, $log) {
	/**
  * @ngdoc property
  ...
  */
	$scope.getWidth = function (column) {
		if (!column.width) {
			return '';
		} else if (column.isFixedWidth === true) {
			// Use pixel width if column is fixed
...
//# sourceMappingURL=TabularDataWidgetController.js.map
