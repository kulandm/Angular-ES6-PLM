 ...
 *
 */
angular.module('plm360.tabularDataWidget').directive('tableColumnSort', ['$document', '$compile', '$timeout', '$log', '$q', '_', function ($document, $compile, $timeout, $log, $q, _) {
	return {
		priority: 3,
		restrict: 'A',
		replace: true,
...
//# sourceMappingURL=TableColumnSort.js.map
