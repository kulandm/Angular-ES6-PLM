...
angular.module('plm360.fieldTypes').directive('fieldView', ['$compile', '$rootScope', '$location', '$state', 'ModelsManager', 'EventService', 'LocalizationService', '$stateParams', '$mdDialog', '_', function ($compile, $rootScope, $location, $state, ModelsManager, EventService, LocalizationService, $stateParams, $mdDialog, _) {
	return {
		restrict: 'E',
		replace: true,
		scope: {
		...
		link: function link(scope, element, attrs) {
			if (angular.isDefined(scope.fieldData) && scope.fieldData.value === null) {
				// check if scope.fieldData is undefined
			...
			if (angular.isDefined(scope.fieldData) && angular.isDefined(scope.fieldData.fieldMetadata) && angular.isDefined(scope.fieldData.fieldMetadata.unitOfMeasure) && scope.fieldData.fieldMetadata.unitOfMeasure !== null && scope.fieldData.value !== '' && angular.isDefined(scope.fieldData.metadata)) {
    ...
    */
			...
			if (angular.isDefined(scope.fieldData) && angular.isDefined(scope.fieldData.metadata) && scope.fieldData.metadata.dataTypeId === 16) {
    ...
    */
			...
			if (angular.isDefined(scope.fieldData) && angular.isDefined(scope.fieldData.metadata) && scope.fieldData.metadata.dataTypeId === 3) {
...
//# sourceMappingURL=FieldViewDirective.js.map
