...
angular.module('plm360.reportChart').directive('reportChart', [function () {
	return {
		restrict: 'E',
		replace: true,
		scope: {
		...
		link: function link(scope, element, attrs, ReportChartController) {
...
//# sourceMappingURL=ReportChartDirective.js.map
