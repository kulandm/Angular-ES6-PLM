 ...
 */
/* global plm360 */
plm360.factory('WorkspaceViewsService', ['RESTWrapperService', function (RESTWrapperService) {
   ...
   */
		getAvailableFields: function getAvailableFields(workspaceId) {
   ...
   * @returns {Object} 		A promise of the GET request
   */
		getViewData: function getViewData(viewId) {
   ...
   * @returns {Object} 		A promise of the GET request
   */
		saveViewData: function saveViewData(data) {
   ...
   * @returns {Object} 		A promise of the GET request
   */
		getFilterTypes: function getFilterTypes(fieldType) {
...
//# sourceMappingURL=WorkspaceViewsService.js.map
