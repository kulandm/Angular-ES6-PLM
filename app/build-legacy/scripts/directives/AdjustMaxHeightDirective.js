 ...
 */
/* global plm360 */
plm360.directive('adjustMaxHeight', ['$window', '$position', function ($window, $position) {
  ...
  */
    ...
    */
			function getHeight() {
				var docHeight = angular.isDefined(document.height) ? document.height : document.body.offsetHeight;
				return angular.isDefined(scope.heightContextEl) ? scope.heightContextEl.prop('offsetHeight') : docHeight;
			}
...
//# sourceMappingURL=AdjustMaxHeightDirective.js.map
