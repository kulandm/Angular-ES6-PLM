 ...
 */
/* global plm360 */
var userProfileSummary = plm360.directive('userProfileSummary', ['$compile', 'ModelsManager', 'EventService', function ($compile, ModelsManager, EventService) {
	return {
		restrict: 'E',
		replace: true,
		...
		link: function link(scope, element, attrs) {
			...
			var profileItems = [{ key: 'loginName', icon: 'md-person' }, { key: 'address1', icon: 'md-pin-drop' }, { key: 'address2', icon: 'md-pin-drop' }, { key: 'city', icon: 'md-pin-drop' }, { key: 'postal', icon: 'md-pin-drop' }, { key: 'region', icon: 'md-pin-drop' }, { key: 'country', icon: 'md-pin-drop' }, { key: 'industry', icon: 'md-person' }, { key: 'aboutMe', icon: 'md-person' }];
			...
			EventService.listen('user:' + userId + ':done', function (event, obj) {
				...
				if (profileItemsListLength > 4) {
					// 4 because email is always displayed
...
//# sourceMappingURL=UserProfileSummaryDirective.js.map
