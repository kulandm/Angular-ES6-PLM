...
var loadingBarWidget = plm360.directive('loadingBarWidget', ['$compile', '$rootScope', '$timeout', '$log', 'GlobalSettings', 'AuthenticationService', 'LoadingBarWidgetConfig', 'EventService', '_', function ($compile, $rootScope, $timeout, $log, GlobalSettings, AuthenticationService, LoadingBarWidgetConfig, EventService, _) {
	return {
		restrict: 'E',
		replace: true,
		scope: true,
    ...
    */
			var updateAnimation = function updateAnimation(requestsCount) {
				/* global $ */
    ...
    */
			var resetLoadingProcess = function resetLoadingProcess() {
...
//# sourceMappingURL=LoadingBarWidgetDirective.js.map
