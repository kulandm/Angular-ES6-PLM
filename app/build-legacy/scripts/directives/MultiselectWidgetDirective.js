 ...
 */
/* global plm360 */
var multiselectWidget = plm360.directive('multiselectWidget', ['$compile', 'LocalizationService', '$rootScope', function ($compile, LocalizationService, $rootScope) {
	return {
		replace: true,
		restrict: 'E',
		scope: {
    ...
    */
			var handleFiltering = function handleFiltering(quantity) {
    ...
    */
			var displayTooManyResultsWarning = function displayTooManyResultsWarning(quantity) {
				scope.displayWarning = true;
...
//# sourceMappingURL=MultiselectWidgetDirective.js.map
