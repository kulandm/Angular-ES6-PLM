...
var plm360models = angular.module('plm360.models', ['com/autodesk/EventService.js', 'com/autodesk/UrnParser.js', 'com/autodesk/services/UrlParser.js', 'com/autodesk/RESTWrapperService.js', 'com/autodesk/services/PermissionService.js', 'com/autodesk/services/PLMPermissions.js', 'com/autodesk/localization.js', 'com/autodesk/classification.js', 'com/autodesk/services/FieldTypeMappings.js', 'com/autodesk/models/bomApi/bomNestedItem.model.js', 'com/autodesk/models/bomApi/bomNestedItemListeners.service.js', 'com/autodesk/models/bomApi/bomRoot.model.js', 'com/autodesk/models/bomApi/bomRootListeners.service.js', 'com/autodesk/models/bomTable/bomTable.js', 'com/autodesk/models/bomGraph/bomGraph.js', 'com/autodesk/models/bomViewDefinition/bomViewDefinition.js', 'com/autodesk/models/configurations/configurations.js', 'com/autodesk/models/bulkBom/bulkBom.js', 'com/autodesk/models/bomAttachment/bomAttachment.js']);

var plm360 = angular.module('plm360', ['oc.lazyLoad', 'ui.router', 'ngRoute', 'ngResource', 'ngSanitize', 'angular-data.DSCacheFactory', 'angular-locale-bundles', 'tmh.dynamicLocale', 'restangular', 'textAngular', 'com/autodesk/UnderscoreService.js', 'com/autodesk/TokenService.js', 'com/autodesk/AuthenticationService.js', 'com/autodesk/ClassicRedirector.js', 'com/autodesk/EventService.js', 'com/autodesk/services/FieldTypeMappings.js', 'com/autodesk/LoadingDataService.js', 'com/autodesk/services/PermissionService.js', 'com/autodesk/RESTWrapperService.js', 'com/autodesk/services/SupportedFieldsService.js', 'com/autodesk/services/UrlParser.js', 'com/autodesk/services/ValidationUtil.js', 'com/autodesk/services/LocalUserStorage.service.js', 'com/autodesk/UrnParser.js', 'com/autodesk/tableData.js', 'com/autodesk/fieldSelector.js', 'com/autodesk/usersSelector.js', 'com/autodesk/dashboard.js', 'com/autodesk/jitterbit.js', 'com/autodesk/search.js', 'com/autodesk/roamer.js', 'com/autodesk/components/createItem/createItem.js', 'com/autodesk/localization.js', 'com/autodesk/components/itemHeader/itemHeader.js', 'com/autodesk/components/itemViewer/itemViewer.js', 'com/autodesk/notification.js', 'com/autodesk/classification.js', 'com/autodesk/flyout.js', 'com/autodesk/components/plmNavigation/plmNavigation.js', 'com/autodesk/components/plmWrapper/plmWrapper.js', 'com/autodesk/components/plmFooter/plmFooter.js', 'com/autodesk/components/fusionHeader/fusionHeader.js', 'com/autodesk/sectionWrapper.js', 'com/autodesk/components/confirmationDialog/confirmationDialog.js', 'com/autodesk/navGuard/navGuard.js', 'com/autodesk/userAvatar.js', 'com/autodesk/components/workspaceItem/commandBar/commandBar.js', 'com/autodesk/components/workspaceItem/addItem/addItem.js', 'com/autodesk/components/workspaceItem/changeOwner/changeOwner.js', 'com/autodesk/components/workspaceItem/removeItemConfirmation/removeItemConfirmation.js', 'com/autodesk/components/workspaceItem/viewAffectedItems/viewAffectedItems.js', 'com/autodesk/components/workspaceItem/viewAttachedItems/viewAttachedItems.js', 'com/autodesk/components/workspaceItem/viewAttachments/viewAttachments.js', 'com/autodesk/components/workspaceItem/viewChangeLog/viewChangeLog.js', 'com/autodesk/components/workspaceItem/viewDetails/viewDetails.js', 'com/autodesk/components/workspaceItem/viewBom/viewBom.js', 'com/autodesk/components/workspaceItem/viewGrid/viewGrid.js', 'com/autodesk/components/workspaceItem/viewMilestones/viewMilestones.js', 'com/autodesk/components/workspaceItem/viewNamedRelationships/viewNamedRelationships.js', 'com/autodesk/components/workspaceItem/viewProjectManagement/viewProjectManagement.js', 'com/autodesk/components/workspaceItem/viewRelationships/viewRelationships.js', 'com/autodesk/components/workspaceItem/viewWipAttachments/viewWipAttachments.js', 'com/autodesk/components/workspaceItem/viewWorkflow/viewWorkflow.js', 'com/autodesk/components/workspaceItem/viewWorkflowActions/viewWorkflowActions.js', 'com/autodesk/components/workspaceItem/viewSourcing/viewSourcing.js', 'com/autodesk/components/featureToggle/featureToggle.js', 'com/autodesk/components/workspaceItem/viewBom/bomPinning.directive.js', 'com/autodesk/components/workspaceTableauFlyout/workspaceTableauFlyout.js', 'com/autodesk/components/plmTableCheckbox/plmTableCheckbox.js', 'com/autodesk/dropdown.js', 'com/autodesk/apiModelsManager.js', 'com/autodesk/plm-bom-module.js', 'plm.httpInterceptor', 'plm360.models', 'ADSK.HttpInterceptorService', 'ngAnimate', 'ngMaterial', 'ngAria', 'ui.grid', 'ui.grid.autoResize', 'ui.grid.resizeColumns', 'ui.grid.moveColumns', 'ui.grid.treeView', 'ui.grid.selection', 'ui.mask', 'com/autodesk/cpdm.js', 'digitalfondue.dftabmenu', 'highcharts-ng', 'ngFileSaver']);

var plm360ResolveConfig = angular.module('plm360.resolveConfig');

plm360.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$uiViewScrollProvider', '$controllerProvider', '$compileProvider', 'LocalizationServiceProvider', 'NotificationServiceProvider', '$urlMatcherFactoryProvider', function ($stateProvider, $urlRouterProvider, $locationProvider, $uiViewScrollProvider, $controllerProvider, $compileProvider, LocalizationServiceProvider, NotificationServiceProvider, $urlMatcherFactoryProvider) {
  ...
  */
	$urlMatcherFactoryProvider.type('UrnType', {}, function (UrnParser) {
		return {
			encode: function encode(urn) {
				return UrnParser.encode(urn);
			},

			decode: function decode(encodedUrn) {
  ...
  */
	var attachmentsControllerProvider = function attachmentsControllerProvider(isWipEnabled) {
  ...
  * @returns {String} html
  */
	var attachmentsTemplateProvider = function attachmentsTemplateProvider($templateRequest, isWipEnabled) {
		return $templateRequest(isWipEnabled === true ? 'build/components/workspaceItem/viewWipAttachments/viewWipAttachments.html' : 'build/components/workspaceItem/viewAttachments/viewAttachments.html');
	};

	// resolve object for attachments ui states (view and edit).
	var attachmentsResolveObj = {
		isWipEnabled: function isWipEnabled(ModelsManager, EventService, $q, _) {
	...
	.state('change-log', {
		...
		resolve: {
			checkPerm: function checkPerm($q, $timeout) {
				var deferred = $q.defer();
				$timeout(function () {
					deferred.resolve();
				}, 5000);
 ...
 *
 */
plm360.run(['$rootScope', '$window', 'LoadingDataService', function ($root, $window, LoadingDataService) {
	...
	$root.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
		...
		if (angular.isDefined(fromState) && angular.isDefined(fromState.name)) {
			if (requestedPath !== null) {
				// still in the middle of a loading, therefore user probably navigated away
 ...
 *
 */
plm360.config(['tmhDynamicLocaleProvider', function (tmhDynamicLocaleProvider) {
...
plm360.config(['RestangularProvider', function (RestangularProvider) {
...
}]).run(['GlobalSettings', 'Restangular', 'EventService', function (GlobalSettings, Restangular, EventService) {
...
*/
plm360.run(['OutstandingWork', 'BookmarkedItems', 'RecentlyViewed', 'Reports', 'Report', 'User', 'UserPermissions', 'Workspaces', 'Workspace', 'Views', 'View', 'Items', 'Item', 'BomRootListeners', 'BomNested', 'BomNestedItemListeners', 'ViewDefinitionsListeners', 'ViewDefinitionListeners', 'ViewDefinitionFieldListeners', 'BulkBomListeners', 'Tabs', 'Transitions', 'Revisions', 'State', 'ChangeLog', 'GridData', 'GridMeta', 'AffectedItems', 'AffectedItem', 'AffectedItemsMeta', 'LinkedItemTransitions', 'LinkableItems', 'LinkedToWorkspaces', 'Milestones', 'RelatedItems', 'RelatedItem', 'Sourcings', 'SourcingQuotes', 'ProjectItems', 'Workflow', 'RelatedWorkspaces', 'Ownership', 'Groups', 'RelatedBomItems', 'RelatedBomItem', 'NamedRelationshipsItem', 'NamedRelationshipsItems', 'EnabledFeatures', 'Picklist', 'ConfigurationsListeners', 'WorkspaceTableau', function () {}]);
