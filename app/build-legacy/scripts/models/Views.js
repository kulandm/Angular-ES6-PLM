...
Views.prototype = {
  ...
  */
	getDefaultViewId: function getDefaultViewId() {
  ...
  */
	getViewLink: function getViewLink(viewId) {
		if (angular.isUndefined(this.json) || angular.isUndefined(this.json.items)) {
			return '';
		}
		var viewObj = '';
  ...
  *
  */
	setViewObj: function setViewObj(viewId, obj) {
		if (angular.isUndefined(this.json) || angular.isUndefined(this.json.items)) {
			return '';
		}
		var viewObj = '';
...
angular.module('plm360.models').factory('Views', ['RESTWrapperService', 'EventService', function (RESTWrapperService, EventService) {
	var models = {};
