 ...
 *
 */
var ProjectItems = function ProjectItems() {};
...
ProjectItems.prototype = {
  ...
  */
	fetch: function fetch(link, params, headers) {
		var that = this;
...
angular.module('plm360.models').factory('ProjectItems', ['RESTWrapperService', 'EventService', function (RESTWrapperService, EventService) {
	var models = {};
...
//# sourceMappingURL=ProjectItems.js.map
