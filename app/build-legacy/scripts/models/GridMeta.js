...
var GridMeta = function GridMeta() {};
...
GridMeta.prototype = {
  ...
  */
	setRESTWrapperService: function setRESTWrapperService(RESTWrapperService) {
  ...
  */
	fetchFieldDefinitions: function fetchFieldDefinitions() {
		var that = this;
...
angular.module('plm360.models').factory('GridMeta', ['RESTWrapperService', 'EventService', '$q', function (RESTWrapperService, EventService, $q) {
	var models = {};
