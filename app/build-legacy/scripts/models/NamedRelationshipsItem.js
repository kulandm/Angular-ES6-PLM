...
var NamedRelationshipsItem = function NamedRelationshipsItem(json) {
	this.json = json;
};
...
NamedRelationshipsItem.prototype = {
  ...
  */
	getItemDescriptorValue: function getItemDescriptorValue() {
...
angular.module('plm360.models').factory('NamedRelationshipsItem', ['EventService', 'RESTWrapperService', function (EventService, RESTWrapperService) {
	var models = {};
...
//# sourceMappingURL=NamedRelationshipsItem.js.map
