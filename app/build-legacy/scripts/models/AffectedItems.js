...
var AffectedItems = function AffectedItems() {};
...
AffectedItems.prototype = {
  ...
  *
  */
	setFullList: function setFullList(array) {
		this.json = [];
...
angular.module('plm360.models').factory('AffectedItems', ['RESTWrapperService', 'EventService', function (RESTWrapperService, EventService) {
	var models = {};
...
//# sourceMappingURL=AffectedItems.js.map
