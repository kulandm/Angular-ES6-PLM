...
var LinkableItem = function LinkableItem(json) {
	this.json = json;
...
angular.module('plm360.models').factory('LinkableItem', ['RESTWrapperService', 'EventService', function (RESTWrapperService, EventService) {
	var models = {};
...
//# sourceMappingURL=LinkableItem.js.map
