...
State.prototype = {
  ...
  */
	getTransitionLink: function getTransitionLink(workspaceId, dmsId, transitionId) {
		var ret = '';
...
angular.module('plm360.models').factory('State', ['RESTWrapperService', 'EventService', function (RESTWrapperService, EventService) {
	var models = {};
