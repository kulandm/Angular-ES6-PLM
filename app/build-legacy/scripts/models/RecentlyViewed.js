...
var RecentlyViewed = function RecentlyViewed(json) {
	this.json = json;
};
...
angular.module('plm360.models').factory('RecentlyViewed', ['RESTWrapperService', '$state', '$q', 'UrnParser', 'EventService', function (RESTWrapperService, $state, $q, UrnParser, EventService) {
	var models = {};
